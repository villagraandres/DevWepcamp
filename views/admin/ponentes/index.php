                ...
                <?php foreach($ponentes as $ponente){ ?>
                    <tr class="table__tr">
                        ...
                        Editar</a>
                            ...
                            <button data-id="<?php echo $ponente->id ?>" id="eliminarBtn" class="table__accion table__accion--eliminar botonesEliminar" type="submit"> <i class="fa-solid fa-circle-xmark"></i> Eliminar</button>
